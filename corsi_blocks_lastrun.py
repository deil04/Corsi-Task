...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Dell\\Downloads\\corsi_blocks-master\\corsi_blocks-master\\corsi_blocks_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisCorsi_task in corsi_task:
        ...
        if isinstance(corsi_task, data.TrialHandler2) and thisCorsi_task.thisN != corsi_task.thisTrial.thisN:
            continueRoutine = False
        ...
        for thisBlock_sequence in block_sequence:
            ...
            # if trial has changed, end Routine now
            if isinstance(block_sequence, data.TrialHandler2) and thisBlock_sequence.thisN != block_sequence.thisTrial.thisN:
                continueRoutine = False
    ...
    continueRoutine = True
    # update component parameters for each repeat
    text_2.setText('Your maximum blocks remembered was: ' + str(nBlocks-1))
